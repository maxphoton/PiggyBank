...
if DATA_DIR:
    BROADCAST_LOGS_DIR = os.path.join(DATA_DIR, "broadcast_logs")
else:
    BROADCAST_LOGS_DIR = os.getenv("BROADCAST_LOGS_DIR", "broadcast_logs")

# Создаем директорию для логов рассылки, если она не существует
